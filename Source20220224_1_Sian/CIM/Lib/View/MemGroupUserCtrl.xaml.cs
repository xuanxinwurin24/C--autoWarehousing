...
namespace CIM.Lib.View
{
    ...
    partial class MemGroupControl : UserControl
    {
        ...
        {
            clValue.IsReadOnly = Password.CurnUser.Group.Level < 9;
            cbAllCol.Visibility = Password.CurnUser.Group.Level < 9 ? Visibility.Collapsed : Visibility.Visible;
        }
        ...
        private void subVal_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (txt != null)
            { txt.IsHitTestVisible = Password.CurnUser.Group.Level >= 9; }
        }
