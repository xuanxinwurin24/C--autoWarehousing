...
namespace CIM.UILog
{
	...
	public partial class fmUILog : Window
	{
		...
		public fmUILog()
		{
			...
			//frmSysLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";
			//frmBCLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";
			//frmEqLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";
			//frmIFLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";

			//frmSecsLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";
			frmAlarmLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";
			frmAlarmHistoryLog.LogFile.PathName = Environment.CurrentDirectory + @"\LogFile\UI Log";

			//frmSysLog.LogFile.sHead = "System";
			//frmBCLog.LogFile.sHead = "BC";

			//frmEqLog.LogFile.sHead = "Eq";
			//frmIFLog.LogFile.sHead = "RobotIF";
